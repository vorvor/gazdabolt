 ...
 * @endcode
 */
$settings['hash_salt'] = 'yRIf0IEXFCLP2HTcqT4b4iNxu_G7ni17vrYgbsBbRXutqCTwZQmzAL_u6WEYd-u2pxq6Djz7IA';
...
$settings['config_sync_directory'] = 'sites/default/files/config_Q5rYfg_0ZMce2PMYVUj4wfyl5MFPEnfVtAs3GmatgQ65nm25vsGTA1sPVY2UeTMmPqKxzrvFtg/sync';

/**
 * EmailOctopus credentials are supplied by the deployment environment.
 *
 * This keeps the API key out of exported configuration and version control.
 */
if ($email_octopus_api_key = getenv('EMAIL_OCTOPUS_API_KEY')) {
  $config['octopus.adminsettings']['api_key'] = $email_octopus_api_key;
}
